...
htmlhelp_basename = 'RackspaceBigDataApiDeveloperDoc'
...
latex_documents = [
    ('index', 'RackspaceBigDataApiDeveloperDoc.tex',
     'Rackspace Big Data API 2.0 Developer Guide', 'Rackspace', 'manual')
]
...
man_pages = [
    ('index', 'RackspaceBigDataApiDeveloperDoc',
     'Rackspace Big Data API 2.0 Developer Guide', ['Rackspace'], 1)
]
...
texinfo_documents = [
    ('index', 'RackspaceBigDataDeveloperDoc',
     'Rackspace Cloud Big Data API Developer Guide', 'Rackspace',
     'RackspaceCloudBigDataDeveloperDoc',
     'Learn about using the REST API for the Rackspace Cloud BigData',
     'Miscellaneous'),
]

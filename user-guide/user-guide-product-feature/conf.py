# -*- coding: utf-8 -*-
#
# user guide documentation build configuration file, created by
...
project = u'Rackspace XXexampleXX User Guide'
...
extlinks = {
    ...
    'git-repo': ('https://github.com/rackerlabs/XXexampleXX/%s', ''),
...
html_short_title = 'XXexampleXX Guide'
...
htmlhelp_basename = 'XXexampleXXGuidedoc'
...
latex_documents = [
  (master_doc, 'RackspaceXXexampleXXGuide.tex', u'Rackspace XXexampleXX Guide Documentation',
   u'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'rackspacecXXexampleXXuserguide', u'Rackspace XXexampleXX User Guide Documentation',
     [u'Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudCoreInfrastructureServicesUserGuide', u'Rackspace Cloud Core Infrastructure Services User Guide Documentation',
   u'Rackspace', 'RackspaceCloudCoreInfrastructureServicesUserGuide', 'One line description of project.',
   'Miscellaneous'),
]
